package md5a184a05ea3e9cf8109d676e32a99dff2;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Caliburn.Micro.ActivityLifecycleCallbackHandler, Caliburn.Micro.Platform, Version=3.0.1.0, Culture=neutral, PublicKeyToken=null", ActivityLifecycleCallbackHandler.class, __md_methods);
	}


	public ActivityLifecycleCallbackHandler () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ActivityLifecycleCallbackHandler.class)
			mono.android.TypeManager.Activate ("Caliburn.Micro.ActivityLifecycleCallbackHandler, Caliburn.Micro.Platform, Version=3.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
