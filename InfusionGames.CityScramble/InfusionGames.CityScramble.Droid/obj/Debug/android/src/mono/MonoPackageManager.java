...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "InfusionGames.CityScramble.Droid.dll" comes first in this list. */
		"InfusionGames.CityScramble.Droid.dll",
		"Caliburn.Micro.dll",
		...
		"InfusionGames.CityScramble.dll",
		"System.Runtime.dll",
